...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    UIAlertView *welcome = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"Welcome!", @"Welcome title") message:NSLocalizedString(@"The Worlds fastest browser", @"Welcome comment") delegate:nil cancelButtonTitle:NSLocalizedString(@"Proceed", @"Welcome button title") otherButtonTitles:nil];
